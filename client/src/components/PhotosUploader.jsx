                ...
                {addedPhotos.length > 0 && addedPhotos.map((link, index) => (
                    <div key={index} className="h-48 flex relative">
                        ...
                        <button
                            ...
                            className="absolute top-1 right-1 text-white bg-black bg-opacity-50 p-2 rounded-full cursor-pointer transition duration-300 ease-in-out hover:bg-opacity-100">
                            {link === addedPhotos[0] && (
                                <span title="Unmark as main photo">
                        ...
                        <button
                            ...
                            className="absolute bottom-1 right-1 text-white bg-black bg-opacity-50 p-2 rounded-full cursor-pointer transition duration-300 ease-in-out hover:bg-opacity-100">
